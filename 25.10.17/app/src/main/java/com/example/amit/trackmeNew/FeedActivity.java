            ...
            mDatabasewholikes.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.hasChild(curuser.getUid())) {
                        ...
                        //mLikebutton.setImageResource(R.mipmap.ic_thumb_up_white_48dp);
                        //mLikebutton.setBackgroundResource(R.color.colorPrimaryDark);
                    } else {
                        mLikebutton.setImageResource(R.mipmap.ic_star_border_black_48dp);
                        //mLikebutton.setImageResource(R.mipmap.ic_thumb_up_black_48dp);
                    }
                }

...
public class DriverMapActivity extends NavigationDriverActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("UUUUUUUUUUIIIIIIIDDDDDDDDDDDD    " + userId);
        mEmergency.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.wtf("clicked", "clickeddddddddddddddddddddddddddd");
    ...
    private void displayLocation() {
        ...
        Log.e("boolean3", "isclusterrrrrrrrrrrrrrrrrrrrrrrr  " + isClustered);
    ...
    public void getAddress() {
        ...
        try {
            ...
            System.out.println("Addddddddddddddddddddddddddddddddddddddddddddd   " + add);
...
//            Toast.makeText(this, e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    int amit = 0, treatPabo = 0;


    private void clustering() {
        double[][] items = new double[locationlistforcluster.size()][2];

        Log.e("list", "location sizeeeeeeeeeeeeeeeeeeeeeeee  " + locationlistforcluster.size());
        ...
        if (locationlistforcluster.size() > 2) {
            ...
            isClustered = true;
            Log.e("means", "meanaaaaaaaaaaaaaaaaaaaaaaaaa " + means.length);
        } else {
            if (locationlistforcluster.size() < 3) {
                try {
                    Log.e("size", "loactionlist er sizeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeez  " + locationlistforcluster.size());
                    ...
                    if (locationlistforcluster.size() != treatPabo) {
                        ...
                        System.out.println("Add korsiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii    " + amit++ + "taaaaaaaa");
    ...
    private void AddlocationforNewClassify(double lat, double lon) {
        ...
        for (LatLng latLng : locationset) {
            ...
            //double distance = EuclideanDistance(arr,item);
        ...
        Log.e("mini", "minimum distanceeeeeeeeeeeeeeeee  " + mini + " " + locationset.size() + " " + lat + " " + lon + " " + isAdd);
        ...
        if (isAdd == true) {
            ...
            System.out.println("Add korsiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii classify thaika :/   " + amit++ + "taaaaaaaa");
    ...
    int NewClassify(double[][] means, double[] item) {
        ...
        if (minimum > .50000 + 1e-9) {
            ...
            if (isRoamingNotification == true) {
                ...
                Log.wtf("elp","elsapsed seccccccccccccc  "+  elapsedSeconds);
                if(elapsedSeconds>20000)
                {
                    isRoamingNotification = false;
                }
            }
            //Log.d("error","Errrrrrrrrrrrrroooooooooooooooooooooooooooooor");
